<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ejercicio2a.aspx.cs" Inherits="TP2_GRUPO16.Ejercicio2a" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td class="auto-style2" id="lblCuidad">Ciudad:</td>
                    <td class="auto-style3">
                ...
                <tr>
                    ...
                    <td class="auto-style3">
                        <asp:CheckBoxList runat="server" ID="ckbTemas" >
                        </asp:CheckBoxList>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
